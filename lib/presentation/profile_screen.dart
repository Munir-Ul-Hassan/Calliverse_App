import 'package:calliverse/presentation/edit_profile.dart';
...
class _ProfileScreenState extends State<ProfileScreen> {
      ...
      body: SingleChildScrollView( // Wrap the Column with SingleChildScrollView
        ...
        MaterialPageRoute(builder: (context) => EditProfileScreen()),
              ...
              OptionTile(
                ...
                trailing: const Row(
                  children: [
                    Text('Eng (US)',style: TextStyle(color: Colors.blue,fontSize: 14),),
                    SizedBox(width: 9,),
  ...
  child: Switch(
    ...
    activeTrackColor: Colors.grey[300], // Track color when active
...
class OptionTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: onTap,
      child: Padding(
        padding: const EdgeInsets.symmetric(horizontal: 10.0), // Padding on both sides
        child: Column(
          children: [
            Row(
              children: [
                ...
                Expanded(
                  child: Text(
                    text,
                    style: TextStyle(fontSize: 14, color: textColor), // Apply textColor here
                  ),
                ),
