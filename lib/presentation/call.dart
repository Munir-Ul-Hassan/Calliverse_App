import 'package:calliverse/presentation/ai_screen.dart';
import 'package:calliverse/presentation/audio_call_screen.dart';
import 'package:calliverse/presentation/profile_screen.dart';
import 'package:calliverse/presentation/video_call_screen.dart';
...
class _CallState extends State<Call> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: _selectedIndex != 2 // Show bottom nav only if not on ChatbotScreen
          ? BottomNavigationBar(
