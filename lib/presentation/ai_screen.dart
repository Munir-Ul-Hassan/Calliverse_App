...
class ChatbotScreen extends StatelessWidget {
          ...
          Expanded(
            child: Center(
              child: Column(
                ...
                children: [
                  Image.asset(
                    'assets/ai_image.png', // Replace with your image
                    width: 150,
                    height: 150,
                  ),
                  ...
                  const SizedBox(height: 10),
                  Text('Ask me anything what\'s are on \nyour mind. Am here to assist you!'),
                  const SizedBox(height: 10),
                  // Suggested questions
                  Column(
  children: [
  ...
  children: [
    Container(
      ...
      margin: const EdgeInsets.symmetric(vertical: 6, horizontal: 16), // Horizontal margin
      ...
      width: MediaQuery.of(context).size.width - 48, // 16 margin on each side
      child: const Center(
        child: Text(
          ...
          color: Colors.white,
           child: Row(
             children: [
              Expanded(
             child: Container(
               margin: const EdgeInsets.only(left: 16, right: 3, bottom: 8), // Horizontal margin
               decoration: BoxDecoration(
             ...
             decoration: InputDecoration(
               ...
               prefixIcon: Padding(
                 ...
                 child: CircleAvatar(
                   ...
                   child: IconButton(
            onPressed: () {},
            icon: const Icon(Icons.emoji_emotions_outlined, color: Colors.white), // Icon color
