        ...
        child: Stack(
              ...
              child: Container(
                decoration: const BoxDecoration(
                  image: DecorationImage(
                    image: AssetImage('assets/imagevideo.png'), // Background image
                    fit: BoxFit.cover,
                  ),
                ),
              ),
          ...
          child: IconButton(
            ...
            Positioned(
              ...
              right: 30,
              child: Container(
                child: Image.asset('assets/imagevideo.png'), // Video or profile image
              ),
            ),
                        ...
                        Column(
                          children: [
                            IconButton(
                              ...
                              icon: const ImageIcon(
                                AssetImage('assets/video_camera.png'),
                                size: 45,
                                color: Colors.white,
                              ),
                            ),
